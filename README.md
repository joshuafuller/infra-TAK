...
**Latest release: v0.6.7-alpha** — **DataSync:** read-only missions (`MISSION_READONLY_SUBSCRIBER`) now work — Node-RED auto-elevates admin to `MISSION_OWNER` after subscribe; multiple flows (KML + ArcGIS) can share one mission with `strictMode: false`. **TAK Server:** `x509useGroupCacheRequiresExtKeyUsage="false"` for channel support on `makeCert.sh` certs (Skydio etc) — click **Resync LDAP to TAK Server** to apply. **FedHub:** cert gen/rotation now detects missing passwordless sudo and prints the fix. **Postfix:** VPS `mydomain=0` install failure fixed. See **[docs/RELEASE-v0.6.7-alpha.md](docs/RELEASE-v0.6.7-alpha.md)**. Prior: [v0.6.6-alpha](docs/RELEASE-v0.6.6-alpha.md) (Guard Dog disk I/O + Node-RED deploy safety), [v0.6.5-alpha](docs/RELEASE-v0.6.5-alpha.md) (KML + ArcGIS stable-ID / Purge), [v0.6.4-alpha](docs/RELEASE-v0.6.4-alpha.md). Older: [v0.6.1-alpha](docs/RELEASE-v0.6.1-alpha.md), [v0.6.0-alpha](docs/RELEASE-v0.6.0-alpha.md), [v0.5.9-alpha](docs/RELEASE-v0.5.9-alpha.md), [v0.5.8-alpha](docs/RELEASE-v0.5.8-alpha.md), [v0.5.7-alpha](docs/RELEASE-v0.5.7-alpha.md), [v0.5.6-alpha](docs/RELEASE-v0.5.6-alpha.md), [v0.5.5-alpha](docs/RELEASE-v0.5.5-alpha.md), [v0.5.4-alpha](docs/RELEASE-v0.5.4-alpha.md), [v0.5.3-alpha](docs/RELEASE-v0.5.3-alpha.md), [v0.5.2-alpha](docs/RELEASE-v0.5.2-alpha.md), [v0.5.1-alpha](docs/RELEASE-v0.5.1-alpha.md), [v0.5.0-alpha](docs/RELEASE-v0.5.0-alpha.md), [v0.4.9-alpha](docs/RELEASE-v0.4.9-alpha.md), [v0.4.8-alpha](docs/RELEASE-v0.4.8-alpha.md), [v0.4.7-alpha](docs/RELEASE-v0.4.7-alpha.md), [v0.4.6-alpha](docs/RELEASE-v0.4.6-alpha.md), [v0.4.5-alpha](docs/RELEASE-v0.4.5-alpha.md), [v0.4.4-alpha](docs/RELEASE-v0.4.4-alpha.md), [v0.4.3-alpha](docs/RELEASE-v0.4.3-alpha.md), [v0.4.2-alpha](docs/RELEASE-v0.4.2-alpha.md).
