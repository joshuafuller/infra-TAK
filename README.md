...
- `idle_in_transaction_session_timeout` reduced from 120s to 10s. PostgreSQL container is auto-recreated by the migration to apply the new command-line arg.
