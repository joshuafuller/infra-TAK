...
function initTakDeployModeUI(rootEl){
    ...
    var extHtml=[
      ...
      '</div>',
      '<div class="form-field" style="margin-bottom:12px"><label>App User Password</label><input type="password" id="edb_password" placeholder="DB user password (leave blank to auto-generate)" autocomplete="off" style="width:100%;padding:8px 12px;background:#0a0e1a;border:1px solid var(--border);border-radius:6px;color:var(--text-primary);font-family:\'JetBrains Mono\',monospace;font-size:12px"></div>',
      ...
      '<div class="form-field"><label>Admin Password</label><input type="password" id="edb_admin_pass" placeholder="RDS master password" autocomplete="off" style="width:100%;padding:8px 12px;background:#0a0e1a;border:1px solid var(--border);border-radius:6px;color:var(--text-primary);font-family:\'JetBrains Mono\',monospace;font-size:12px"></div>',
      '</div>',
