...
const FN_BUILD_QUERY = [
  ...
  "  var lyr = layers[li];",
  "  var m = { topic: msg.topic, _config: JSON.parse(JSON.stringify(cfg)), headers: msg.headers || {} };",
  ...
  "  m._layerName = lyr.layerName || String(lyr.layerId);",
...
"  var _hash = djb2(hp.join('|'));",
  ...
  "  var fColor_s = cls.color || sColor;",
  "  var fColor_f = cls.fillColor || cls.color || fColor;",
  "  var fStrokeArgb = hexArgb(fColor_s, 1);",
  "  var fFillArgb = hexArgb(fColor_f, fillAlphaFloat);",
  "",
  "  var lat, lon;",
  "  var verts = null;",
  "  if (kind === 'polygon') {",
  ...
  "",
  "  var callsign = uid;",
  "  if (cfg.style.customLabel) callsign = String(cfg.style.customLabel);",
  "  else if (cfg.style.labelField && a[cfg.style.labelField] != null) callsign = String(a[cfg.style.labelField]);",
  "  if (cfg.style.labelUpperCase) callsign = callsign.toUpperCase();",
  "",
  "  function fmtVal(v) {",
  "    if (v == null) return '';",
  "    var n = Number(v);",
  ...
  "    remarks: remarks,",
  "    strokeColor: [{ _attributes: { value: String(fStrokeArgb) } }],",
  "    strokeWeight: [{ _attributes: { value: String(cfg.style.strokeWeight || 3) + '.0' } }],",
  "    fillColor: [{ _attributes: { value: String(fFillArgb) } }],",
