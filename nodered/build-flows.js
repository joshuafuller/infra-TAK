...
const FN_IPAWS_BUILD_KML = [
  ...
  "Promise.all(toFetch.map(function(u) {",
  "  return fetch(u, {",
  "    headers: { 'User-Agent': '(infra-TAK IPAWS, nodered@localhost)', 'Accept': 'application/geo+json' },",
  "    signal: AbortSignal.timeout(15000)",
  "  })",
  "  .then(function(r) { return r.ok ? r.json() : null; })",
  "  .then(function(d) { return { u: u, geom: d && d.geometry ? d.geometry : null }; })",
  "  .catch(function()  { return { u: u, geom: null }; });",
