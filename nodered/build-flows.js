...
const configFlows = [
  ...
  },
  {
    ...
    func: [
      "function _parseCtx(v){",
      "  if(v&&typeof v==='object'&&!Array.isArray(v)&&'msg'in v){var m=v.msg;if(typeof m==='string'){try{return JSON.parse(m);}catch(e){return m;}}return m;}",
      "  if(typeof v==='string'){try{return JSON.parse(v);}catch(e){return v;}}",
      "  return v;",
      "}",
      "try {",
      "  var _fs = global.get('fs') || require('fs');",
      "  var _bd = '/data/config-backups';",
      ...
      "      var ac = _parseCtx(d.arcgis_configs); if(!Array.isArray(ac)) ac=[];",
      "      var tc = _parseCtx(d.tc_configs);     if(!Array.isArray(tc)) tc=[];",
      "      return {",
      "        filename: f,",
      "        timestamp: d.timestamp || null,",
      "        arcgis_count: ac.length,",
      "        tc_count: tc.length,",
  ...
  },
  {
    ...
    func: [
      ...
      "  var ac = _parseCtx(d.arcgis_configs); if(!Array.isArray(ac)) ac=[];",
      "  var tc = _parseCtx(d.tc_configs);     if(!Array.isArray(tc)) tc=[];",
      "  var ts = _parseCtx(d.tak_settings);   if(!ts||typeof ts!=='object'||Array.isArray(ts)) ts={};",
      "  var ip = _parseCtx(d.ipaws_config);   if(!ip||typeof ip!=='object'||Array.isArray(ip)) ip={};",
      "  var pp = _parseCtx(d.pulsepoint_config); if(!pp||typeof pp!=='object'||Array.isArray(pp)) pp={};",
      "  global.set('arcgis_configs', ac);",
      "  global.set('tc_configs',     tc);",
      "  global.set('tak_settings',   ts);",
      "  global.set('ipaws_config',   ip);",
      "  global.set('pulsepoint_config', pp);",
      "  msg.payload = {",
      "    ok: true,",
