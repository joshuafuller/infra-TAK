...
const configFlows = [
  ...
  // ── TC connection test ──
  {
    ...
    upload: false, swaggerDoc: '',
    x: 200, y: 1215, wires: [['fn_tc_test']]
  },
  {
    id: 'fn_tc_test', type: 'function', z: CFG_TAB,
    name: 'Test TC endpoint',
    func: [
      "var body = msg.payload || {};",
      ...
      "var http = require('http');",
      "var url = require('url');",
      "var testUrl = agencyUrl + '/0?f=json';",
      ...
      "  headers: { 'User-Agent': 'infra-TAK/tc-test', 'Accept': 'application/json' },",
      "  timeout: 10000",
      "};",
      "var send = node.send.bind(node);",
      ...
      "        msg.payload = {",
      "          ok: true,",
      "          name: d.name || d.serviceName || 'Unnamed service',",
      "          type: d.type || d.geometryType || '',",
      "          featureCount: (d.count != null) ? d.count : null,",
      "          status: res.statusCode",
      "        };",
      "      }",
      "    } catch(e) {",
      "      msg.payload = { ok: res.statusCode < 400, status: res.statusCode, raw: raw.substring(0, 200) };",
      "    }",
      "    send(msg);",
      "  });",
      "});",
      ...
      "  req.destroy();",
      "  msg.payload = { ok: false, error: 'Connection timed out (10s)' };",
      "  send(msg);",
      "});",
      "req.end();",
      "return;"
