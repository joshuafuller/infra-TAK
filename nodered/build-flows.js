...
const CFG_BACKUP_SNIPPET = [
  ...
  "    pulsepoint_config: _parseForSnap(global.get('pulsepoint_config')) || {}",
  "  };",
...
const configFlows = [
  ...
  },
  {
    ...
    func: [
      ...
      "  return { filename: filename, timestamp: d.timestamp||null, arcgis_count: ac.length, tc_count: tc.length,",
  ...
  },
  {
    ...
    func: [
      ...
      "  var pp=_pc(d.pulsepoint_config); if(!pp||typeof pp!=='object'||Array.isArray(pp)) pp={};",
