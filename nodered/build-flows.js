...
const FN_PARSE_COT = [
  ...
  "  var g = f.geometry;",
  "  if (!g) continue;",
  "  var gClean = {}; if (g.x!=null) { gClean.x=Math.round(g.x*1e6)/1e6; gClean.y=Math.round(g.y*1e6)/1e6; }",
  "  if (g.rings) gClean.rings=g.rings; if (g.paths) gClean.paths=g.paths;",
  "  var hp = [JSON.stringify(gClean)];",
  ...
  return [
    ...
    },
    {
      ...
      func: [
        ...
        "var pollKey = '_lastPoll_' + cfg.configName;",
